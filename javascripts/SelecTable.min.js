...
k.prototype.f=function(){return this.selected};function m(b){for(var a=0;a<b.rows.length;a++)l(b,a)}window.SelecTable=k;Select.prototype.getSelectedRow=k.prototype.f;